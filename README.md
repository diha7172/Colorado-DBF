...
1. In GoDaddy (My Products, then DNS next to coloradodbf.com) delete the `www` CNAME that points to `ghs.googlehosted.com` and any Google Sites A records or forwarding rules, then add:
